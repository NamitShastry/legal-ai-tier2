...
pdf_path = "data/raw/acts/land_acquisition_act_2013.pdf"
...
if not os.path.exists(pdf_path):
    ...
    act_title = "Land Acquisition Act, 2013"

    for idx, chunk in enumerate(raw_chunks):
        if len(chunk.strip()) > 50:
            documents.append(chunk)
            metadatas.append({"act": act_title, "file_name": "land_acquisition_act_2013.pdf"})
            ids.append(f"land_acquisition_{idx}")
