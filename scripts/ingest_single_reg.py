...
pdf_path = "data/raw/acts/registration_act_1908.pdf"
...
if not os.path.exists(pdf_path):
    ...
    act_title = "The Registration Act, 1908"

    for idx, chunk in enumerate(raw_chunks):
        if len(chunk.strip()) > 50:
            documents.append(chunk)
            metadatas.append({"act": act_title, "file_name": "registration_act_1908.pdf"})
            ids.append(f"registration_act_{idx}")
