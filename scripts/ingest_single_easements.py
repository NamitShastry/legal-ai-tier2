...
pdf_path = "data/raw/acts/indian_easements_act_1882.pdf"
...
if not os.path.exists(pdf_path):
    ...
    act_title = "Indian Easements Act, 1882"

    for idx, chunk in enumerate(raw_chunks):
        if len(chunk.strip()) > 50:
            documents.append(chunk)
            metadatas.append({"act": act_title, "file_name": "indian_easements_act_1882.pdf"})
            ids.append(f"easements_{idx}")
