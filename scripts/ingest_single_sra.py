...
pdf_path = "data/raw/acts/specific_relief_act_1963.pdf"
...
if not os.path.exists(pdf_path):
    ...
    act_title = "Specific Relief Act, 1963"

    for idx, chunk in enumerate(raw_chunks):
        if len(chunk.strip()) > 50:
            documents.append(chunk)
            metadatas.append({"act": act_title, "file_name": "specific_relief_act_1963.pdf"})
            ids.append(f"specific_relief_{idx}")
