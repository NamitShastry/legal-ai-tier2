...
pdf_path = "data/raw/up_noida/noida_transfer_rules.pdf"
...
if not os.path.exists(pdf_path):
    ...
    act_title = "Noida Authority Allotment and Transfer Manual Rules"
        ...
        for chunk in raw_chunks:
            if len(chunk.strip()) > 50:
                ...
                batch_metas.append({
                    ...
                    "file_name": "noida_transfer_rules.pdf"
                })
                batch_ids.append(f"noida_trf_{chunk_counter}")
                chunk_counter += 1
