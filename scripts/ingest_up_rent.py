...
pdf_path = "data/raw/up_noida/up_rent_act_1972.pdf"
...
if not os.path.exists(pdf_path):
    ...
    act_title = "UP Urban Buildings (Regulation of Letting, Rent and Eviction) Act, 1972"
        ...
        for chunk in raw_chunks:
            if len(chunk.strip()) > 50:
                ...
                batch_metas.append({
                    ...
                    "file_name": "up_rent_act_1972.pdf"
                })
                batch_ids.append(f"up_rent_{chunk_counter}")
                chunk_counter += 1
