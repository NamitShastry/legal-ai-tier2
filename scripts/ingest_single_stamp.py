...
pdf_path = "data/raw/acts/indian_stamp_act_1899.pdf"
...
if not os.path.exists(pdf_path):
    ...
    act_title = "Indian Stamp Act, 1899"

    for idx, chunk in enumerate(raw_chunks):
        if len(chunk.strip()) > 50:
            documents.append(chunk)
            metadatas.append({"act": act_title, "file_name": "indian_stamp_act_1899.pdf"})
            ids.append(f"stamp_act_{idx}")
